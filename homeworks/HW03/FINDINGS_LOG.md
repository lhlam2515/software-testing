...
| — Type: Bug |  |
| — Type: Usability |  |
| From Task 1B (checklist run) |  |
| From Task 2 (user testing) |  |
| From Task 3 (cross-platform) |  |
| Submitted to Google Form |  |
| **Log rows == form submissions?** |  |
...
| Screen | _TBD_ |
| Type | Bug / Usability |
| Source task | Task 1B / Task 2 / Task 3 |
| Severity | _TBD_ |
| Heuristic violated (usability only) | _TBD_ |
| Environment (OS / browser / device) | _TBD_ |
...
_TBD (path under `artifacts/screens/…/screenshots/` or `artifacts/compatibility/screenshots/…`)_

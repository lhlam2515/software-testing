  ...
  - rowgroup:
    ...
    - row "Bàn phím cơ Keychron Q1 Bàn phím cơ Keychron Q1 4000000 ₫ Sửa Xóa":
      ...
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 1 [TC-12-pw-57251] Valid Product 1 [TC-12-pw-57251] 100000 ₫ Sửa Xóa":
      - cell "Valid Product 1 [TC-12-pw-57251]":
        - img "Valid Product 1 [TC-12-pw-57251]"
      - cell "Valid Product 1 [TC-12-pw-57251]"
      - cell "100000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row [TC-12-pw-57251] Invalid Row [TC-12-pw-57251] 0 ₫ Sửa Xóa":
      - cell "Invalid Row [TC-12-pw-57251]":
        - img "Invalid Row [TC-12-pw-57251]"
      - cell "Invalid Row [TC-12-pw-57251]"
      - cell "0 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 2 [TC-12-pw-57251] Valid Product 2 [TC-12-pw-57251] 200000 ₫ Sửa Xóa":
      - cell "Valid Product 2 [TC-12-pw-57251]":
        - img "Valid Product 2 [TC-12-pw-57251]"
      - cell "Valid Product 2 [TC-12-pw-57251]"
      - cell "200000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
...
```
Error: product not created: Valid Product 1 [TC-12-pw-57251]
...
```
Error: product not created: Valid Product 2 [TC-12-pw-57251]

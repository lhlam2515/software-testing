...
- Name: FR-16/csv-import.spec.ts >> FR-16 — CSV Product Import (EP + BVA) >> TC-18 — Gap Probe: all-rows-invalid batch must list a distinct reason per row
...
Received string:    "✅ Import hoàn tất: 3/3 sản phẩm được thêm"
Timeout: 5000ms

Call log:
  - Expect "soft toContainText" with timeout 5000ms
  - waiting for getByText(/Import hoàn tất/)
    14 × locator resolved to <p>✅ Import hoàn tất: 3/3 sản phẩm được thêm</p>
       - unexpected value "✅ Import hoàn tất: 3/3 sản phẩm được thêm"
...
Locator:  getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 2:/ })
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveCount" with timeout 5000ms
  - waiting for getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 2:/ })
    14 × locator resolved to 0 elements
       - unexpected value "0"
  ...
  - rowgroup:
    ...
    - row "Bàn phím cơ Keychron Q1 Bàn phím cơ Keychron Q1 4000000 ₫ Sửa Xóa":
      ...
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 1 [TC-18-pw-187679] Invalid Row 1 [TC-18-pw-187679] 0 ₫ Sửa Xóa":
      - cell "Invalid Row 1 [TC-18-pw-187679]":
        - img "Invalid Row 1 [TC-18-pw-187679]"
      - cell "Invalid Row 1 [TC-18-pw-187679]"
      - cell "0 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 2 [TC-18-pw-187679] Invalid Row 2 [TC-18-pw-187679] -1 ₫ Sửa Xóa":
      - cell "Invalid Row 2 [TC-18-pw-187679]":
        - img "Invalid Row 2 [TC-18-pw-187679]"
      - cell "Invalid Row 2 [TC-18-pw-187679]"
      - cell "-1 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 3 [TC-18-pw-187679] Invalid Row 3 [TC-18-pw-187679] abc ₫ Sửa Xóa":
      - cell "Invalid Row 3 [TC-18-pw-187679]":
        - img "Invalid Row 3 [TC-18-pw-187679]"
      - cell "Invalid Row 3 [TC-18-pw-187679]"
      - cell "abc ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
...
Locator:  getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 3:/ })
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveCount" with timeout 5000ms
  - waiting for getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 3:/ })
    14 × locator resolved to 0 elements
       - unexpected value "0"
...
Locator:  getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 4:/ })
Expected: 1
Received: 0
Timeout:  5000ms
...
Call log:
  - Expect "soft toHaveCount" with timeout 5000ms
  - waiting for getByRole('listitem').filter({ hasText: /^Hàng \d+:/ }).filter({ hasText: /^Hàng 4:/ })
    14 × locator resolved to 0 elements
       - unexpected value "0"
...
```
Error: TC-18: products count remains unchanged; observed [3,3,3,3,3,3,3,3,3,3]
...
```
Error: product not created: Invalid Row 1 [TC-18-pw-187679]
...
```
Error: product not created: Invalid Row 2 [TC-18-pw-187679]
...
```
Error: product not created: Invalid Row 3 [TC-18-pw-187679]

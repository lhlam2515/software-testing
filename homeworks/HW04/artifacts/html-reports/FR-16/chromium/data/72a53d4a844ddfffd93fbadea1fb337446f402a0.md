  ...
  - rowgroup:
    ...
    - row "Bàn phím cơ Keychron Q1 Bàn phím cơ Keychron Q1 4000000 ₫ Sửa Xóa":
      ...
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 1 [TC-18-pw-57822] Invalid Row 1 [TC-18-pw-57822] 0 ₫ Sửa Xóa":
      - cell "Invalid Row 1 [TC-18-pw-57822]":
        - img "Invalid Row 1 [TC-18-pw-57822]"
      - cell "Invalid Row 1 [TC-18-pw-57822]"
      - cell "0 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 2 [TC-18-pw-57822] Invalid Row 2 [TC-18-pw-57822] -1 ₫ Sửa Xóa":
      - cell "Invalid Row 2 [TC-18-pw-57822]":
        - img "Invalid Row 2 [TC-18-pw-57822]"
      - cell "Invalid Row 2 [TC-18-pw-57822]"
      - cell "-1 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row 3 [TC-18-pw-57822] Invalid Row 3 [TC-18-pw-57822] abc ₫ Sửa Xóa":
      - cell "Invalid Row 3 [TC-18-pw-57822]":
        - img "Invalid Row 3 [TC-18-pw-57822]"
      - cell "Invalid Row 3 [TC-18-pw-57822]"
      - cell "abc ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
...
```
Error: product not created: Invalid Row 1 [TC-18-pw-57822]
...
```
Error: product not created: Invalid Row 2 [TC-18-pw-57822]
...
```
Error: product not created: Invalid Row 3 [TC-18-pw-57822]

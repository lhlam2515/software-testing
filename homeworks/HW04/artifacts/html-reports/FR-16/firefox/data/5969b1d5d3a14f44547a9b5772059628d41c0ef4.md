  ...
  - rowgroup:
    ...
    - row "Bàn phím cơ Keychron Q1 Bàn phím cơ Keychron Q1 4000000 ₫ Sửa Xóa":
      ...
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 1 [TC-12-pw-60622] Valid Product 1 [TC-12-pw-60622] 100000 ₫ Sửa Xóa":
      - cell "Valid Product 1 [TC-12-pw-60622]":
        - img "Valid Product 1 [TC-12-pw-60622]"
      - cell "Valid Product 1 [TC-12-pw-60622]"
      - cell "100000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row [TC-12-pw-60622] Invalid Row [TC-12-pw-60622] 0 ₫ Sửa Xóa":
      - cell "Invalid Row [TC-12-pw-60622]":
        - img "Invalid Row [TC-12-pw-60622]"
      - cell "Invalid Row [TC-12-pw-60622]"
      - cell "0 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 2 [TC-12-pw-60622] Valid Product 2 [TC-12-pw-60622] 200000 ₫ Sửa Xóa":
      - cell "Valid Product 2 [TC-12-pw-60622]":
        - img "Valid Product 2 [TC-12-pw-60622]"
      - cell "Valid Product 2 [TC-12-pw-60622]"
      - cell "200000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
...
```
Error: product not created: Valid Product 1 [TC-12-pw-60622]
...
```
Error: product not created: Valid Product 2 [TC-12-pw-60622]

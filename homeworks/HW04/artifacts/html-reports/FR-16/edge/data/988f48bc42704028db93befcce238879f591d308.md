...
- Name: FR-16/csv-import.spec.ts >> FR-16 — CSV Product Import (EP + BVA) >> TC-12 — Atomic rollback: 1 invalid row among 3 must roll back the entire batch
  ...
  - rowgroup:
    ...
    - row "Bàn phím cơ Keychron Q1 Bàn phím cơ Keychron Q1 4000000 ₫ Sửa Xóa":
      ...
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 1 [TC-12-pw-109185] Valid Product 1 [TC-12-pw-109185] 100000 ₫ Sửa Xóa":
      - cell "Valid Product 1 [TC-12-pw-109185]":
        - img "Valid Product 1 [TC-12-pw-109185]"
      - cell "Valid Product 1 [TC-12-pw-109185]"
      - cell "100000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Invalid Row [TC-12-pw-109185] Invalid Row [TC-12-pw-109185] 0 ₫ Sửa Xóa":
      - cell "Invalid Row [TC-12-pw-109185]":
        - img "Invalid Row [TC-12-pw-109185]"
      - cell "Invalid Row [TC-12-pw-109185]"
      - cell "0 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
        - button "Xóa"
    - row "Valid Product 2 [TC-12-pw-109185] Valid Product 2 [TC-12-pw-109185] 200000 ₫ Sửa Xóa":
      - cell "Valid Product 2 [TC-12-pw-109185]":
        - img "Valid Product 2 [TC-12-pw-109185]"
      - cell "Valid Product 2 [TC-12-pw-109185]"
      - cell "200000 ₫"
      - cell "Sửa Xóa":
        - button "Sửa"
...
```
Error: TC-12: products count remains unchanged; observed [3,3,3,3,3,3,3,3,3,3]
...
```
Error: product not created: Valid Product 1 [TC-12-pw-109185]
...
```
Error: product not created: Valid Product 2 [TC-12-pw-109185]

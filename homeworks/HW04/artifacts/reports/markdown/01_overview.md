...
| **Test type** | Data-driven, multi-browser (Chromium / Firefox / Edge — Edge substitutes for WebKit, see `bugs/BUG_REPORT.md`), one `test()` per case in `test-data/<FR>/cases.json` |
...
Edge for reasons unrelated to the feature under test (HTML5 validation

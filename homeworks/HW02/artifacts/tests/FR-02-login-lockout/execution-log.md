...
| **Screenshot** | `artifacts/bugs/screenshots/TC-01-pass-homepage.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-02-empty-email.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/BUG-02-001-type-text-invalid-email.png` |
| **Bug ID** | **BUG-02-001** |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-04-unregistered-email.png` |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-05-empty-password.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-07-locked-correct-creds.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-BVA-01-lock-triggered.png` |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-BVA-03-still-locked-29s.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-BVA-04-boundary-allowed.png` |
| **Bug ID** | — |
...
| **Screenshot** | `artifacts/bugs/screenshots/TC-BVA-05-unlocked-success.png` |
| **Bug ID** | — |

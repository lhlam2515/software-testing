...
$plan = Join-Path $baseDir 'plans\23127543_Spike_20260811.jmx'
$jtl = Join-Path $baseDir 'results\23127543_Spike_20260811.jtl'
$report = Join-Path $baseDir 'reports\spike'
...
Write-Host "Running Spike plan: $plan"

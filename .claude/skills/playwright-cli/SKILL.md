...
playwright-cli eval "document.title"              # extract specific values
playwright-cli --raw eval "JSON.stringify([...document.querySelectorAll('a')].map(a => a.href))" > links.json
playwright-cli screenshot --filename=page.png     # capture a visual snapshot
playwright-cli close
```
...
playwright-cli fill e2 "another value"
playwright-cli click e3                           # submit button ref
...
# later
playwright-cli state-load auth.json               # skip login on next run
```

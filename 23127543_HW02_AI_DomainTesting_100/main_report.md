...
|---|---:|---:|---:|---:|---:|---:|---:|---:|
| FR-04 Profile | 12 | 6 | 18 | 11 | 2 | 1 | 8 | 7 |
| FR-08 Checkout | 12 | 13 | 25 | 12 | 6 | 2 | 4 | 13 |
| FR-18 Admin Order Management | 12 | 6 | 18 | 14 | 2 | 12 | 0 | 4 |
| FR-20 Mobile Checkout | 12 | 6 | 18 | 0 | 0 | 0 | 0 | 18 |
| **Total** | **48** | **31** | **79** | **37** | **10** | **15** | **12** | **42** |

Generated API logs exist in `test_scripts/results/json/` and `test_scripts/results/html/`. JSON logs were used as the primary source for this update. Screenshot evidence is not included in this update pass.

## 6. Bug Summary

The bug report is maintained in [bug_report.md](bug_report.md). Based on the generated result logs, this update records 6 confirmed bug entries and 12 potential bugs requiring review. GitHub-Issue-ready text is prepared in [github_issue_bugs.txt](github_issue_bugs.txt).
